...
./../MiniNezVM/src/mini_instruction_opt_vm/build/nezvm -t stat -p minivmByteCode/opt/json.nez.bin -i input/benchmark4.json

echo "\nparse citys.json\n"
./../MiniNezVM/src/mini_instruction_opt_vm/build/nezvm -t stat -p minivmByteCode/opt/json.nez.bin -i input/citys.json
...
./../MiniNezVM/src/mini_instruction_opt_vm/build/nezvm -t stat -p minivmByteCode/opt/xml.nez.bin -i input/geometry_base.xml

echo "\nparse 01HOKKAI_ROME.CSV\n"
./../MiniNezVM/src/mini_instruction_opt_vm/build/nezvm -t stat -p minivmByteCode/opt/csv.nez.bin -i input/01HOKKAI_ROME.CSV
